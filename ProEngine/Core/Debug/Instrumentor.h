    ...
    public:
                          ...
                          const std::string& filepath = "results.json")
        {
            ...
            if (m_CurrentSession) {
                ...
                // output.
                if (PELog::GetCoreLogger()) // Edge case: BeginSession() might
                                            // be before PELog::Init()
                {
                    PENGINE_CORE_ERROR("Instrumentor::BeginSession('{0}') when "
            ...
            if (m_OutputStream.is_open()) {
                ...
                if (ProEngine::PELog::GetCoreLogger()) // Edge case: BeginSession() might
                                            // be before PELog::Init()
                {
                    PENGINE_CORE_ERROR(
...
#define PENGINE_FUNC_SIG __PRETTY_FUNCTION__
#elif defined(__DMC__) && (__DMC__ >= 0x810)
#define PENGINE_FUNC_SIG __PRETTY_FUNCTION__
#elif (defined(__FUNCSIG__) || (_MSC_VER))
#define PENGINE_FUNC_SIG __FUNCSIG__
#elif (defined(__INTEL_COMPILER) && (__INTEL_COMPILER >= 600))                 \
        || (defined(__IBMCPP__) && (__IBMCPP__ >= 500))
#define PENGINE_FUNC_SIG __FUNCTION__
#elif defined(__BORLANDC__) && (__BORLANDC__ >= 0x550)
#define PENGINE_FUNC_SIG __FUNC__
#elif defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 199901)
#define PENGINE_FUNC_SIG __func__
#elif defined(__cplusplus) && (__cplusplus >= 201103)
#define PENGINE_FUNC_SIG __func__
#else
#define PENGINE_FUNC_SIG "PENGINE_FUNC_SIG unknown!"
#endif

#define PENGINE_PROFILE_BEGIN_SESSION(name, filepath)                          \
    ::ProEngine::Instrumentor::Get().BeginSession(name, filepath)
...
#define PENGINE_PROFILE_SCOPE(name) PENGINE_PROFILE_SCOPE_LINE(name, __LINE__)
#define PENGINE_PROFILE_FUNCTION()  PENGINE_PROFILE_SCOPE(PENGINE_FUNC_SIG)
#else
#define PENGINE_PROFILE_BEGIN_SESSION(name, filepath)
#define PENGINE_PROFILE_END_SESSION()
#define PENGINE_PROFILE_SCOPE(name)
#define PENGINE_PROFILE_FUNCTION()
#endif
