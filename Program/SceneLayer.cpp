...
namespace ProEngine
{
    ...
    void SceneLayer::OnAttach()
    {
        ...
        camera_controller_ = FilamentCameraController(engine_, render_width_ / (float)render_height_);

        camera_ = camera_controller_.GetCamera().Get();
    ...
    void SceneLayer::LoadGLTFModel()
    {
        ...
        std::vector<std::string> modelPaths = {
            "../ProEngine/Assets/Models/DamagedHelmet.glb",
        };
        ...
        asset_ = asset_loader_->createAsset(buffer.data(), (glm::uint32)buffer.size());
        if (!asset_)
        {
    ...
    void SceneLayer::SetupLighting()
    {
        ...
        filament::LightManager::Builder(filament::LightManager::Type::DIRECTIONAL)
            ...
            .direction({-1, -1, -1})
            .intensity(2000000.0f) // Muito forte
            .castShadows(false)
